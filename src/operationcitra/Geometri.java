...
public class Geometri {
    public static void citraTranslasi (String nama_file1, String tipe_file, int x) {
        try{
            ...
            String output_name = nama_file1 + "_Translasi." + tipe_file;
    ...
    public static void citraHorizontalFlip (String nama_file1, String tipe_file) {
        try{
            String input_name = nama_file1 + "." + tipe_file;
            File input = new File(input_name);
            BufferedImage image = ImageIO.read(input);
            ...
            String output_name = nama_file1 + "_HorizontalFlip." + tipe_file;
            File output = new File(output_name);
            ImageIO.write(image2, tipe_file, output);
        } catch(IOException e) {
            System.out.println("Error = " + e);
    ...
    public static void citraVerticalFlip (String nama_file1, String tipe_file) {
        try{
            String input_name = nama_file1 + "." + tipe_file;
            File input = new File(input_name);
            BufferedImage image = ImageIO.read(input);
            ...
            String output_name = nama_file1 + "_VerticalFlip." + tipe_file;
            File output = new File(output_name);
            ImageIO.write(image2, tipe_file, output);
        } catch(IOException e) {
            System.out.println("Error = " + e);
